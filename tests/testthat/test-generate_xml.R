...
test_that("generate_name generates correct XML with valid inputs", {
  # Input
  ...
  # Call the function
  result <- generate_name(first_question_number, type, orientation, question)
...
test_that("generate_name truncates question to 40 characters", {
  # Input
