...
All questions belong to the same category and share the globally defined values for copyright, license, author, penalty, and feedback.  
...
````{verbatim, lang = "csv"}
"category", "type", "penalty", "id", "name", "author", "fb_general", 
