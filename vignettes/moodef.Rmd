...
We provide two functions for defining questions: `define_question()` and `define_extended_question()`. These are used to define questions in the simple style and the extended style, respectively. **The simple and extended definitions cannot be mixed**.
